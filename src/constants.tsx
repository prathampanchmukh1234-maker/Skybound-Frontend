...
export const CAB_TYPES: CabType[] = [
  { id: 'cab-1', type: 'Hatchback', example: 'WagonR / Alto', image: 'https://images.unsplash.com/photo-1549317661-1f77a9497651?q=80&w=1200', 
    ...
    distance_km: 250 },
  { id: 'cab-2', type: 'Sedan', example: 'Dzire / Etios', image: 'https://images.unsplash.com/photo-1533106497116-4542f14f6d62?q=80&w=1200',
    perKm: 14, baseKm: 250, baseFare: 3500, capacity: 4,
    includes: ['250 km included', 'Fuel', 'Driver allowance', 'Water bottle'],
    excludes: ['Tolls', 'Parking', 'State permits'],
    distance_km: 250 },
  { id: 'cab-3', type: 'SUV', example: 'Ertiga / Innova', image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=1200',
    ...
    distance_km: 250 },
  { id: 'cab-4', type: 'Premium SUV', example: 'Crysta / XUV700', image: 'https://images.unsplash.com/photo-1614200187524-dc4b892acf16?q=80&w=1200',
    perKm: 22, baseKm: 250, baseFare: 5500, capacity: 6,
    includes: ['250 km included', 'Fuel', 'Professional Chauffeur', 'WiFi', 'Water & Snacks'],
    excludes: ['Tolls', 'State permits'],
    distance_km: 250 },
  { id: 'cab-5', type: 'Tempo Traveller', example: '12-Seater', image: 'https://images.unsplash.com/photo-1597007066704-67bf2068d5b2?q=80&w=1200',
